    ...
    <section className="py-12 sm:py-16 md:py-20 bg-background border-t border-border">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 max-w-7xl mx-auto">
          {/* Card 1 */}
          <div className="bg-foreground text-background p-6 sm:p-8 relative rounded-lg">
            ...
            <div className="mb-8 sm:mb-12">
              <div className="text-xs font-medium mb-3 sm:mb-4 text-background/70 uppercase tracking-wider">Pick any date</div>
              <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3">Past or future. Up to 2100.</h3>
          ...
          <div className="bg-foreground text-background p-6 sm:p-8 relative rounded-lg">
            ...
            <div className="mb-8 sm:mb-12">
              <div className="text-xs font-medium mb-3 sm:mb-4 text-background/70 uppercase tracking-wider">Instant analysis</div>
              <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3">Results in minutes.</h3>
              <p className="text-background/80 text-sm">
